...
INSERT INTO oauth_client_details(client_id,
                                 resource_ids, client_secret, scope, authorized_grant_types,
                                 web_server_redirect_uri, authorities, access_token_validity, refresh_token_validity,
                                 additional_information, autoapprove)
VALUES ('client_example', null, 'hocgin', 'user_info', 'client_credentials,password,authorization_code,refresh_token',
        'http://example.hocgin.local:20001/login/oauth2/code/', 'ROLE_USER', 1800, 86400, null, true);
